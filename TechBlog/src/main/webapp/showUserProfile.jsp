...
User user1 = (User) session.getAttribute("userProfile");
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container text-center ">
		<div class="card">
			<div class="card-header primary-background">
				<img style="border-radius: 50%; max-width: 150px" class="img-fluid"
					src="pics/<%=user1.getProfile()%>"> <br>
				<%=user1.getName()%>
			</div>
			<div class="card-body mb-5">
				<div class="row-md-8 my-4">
