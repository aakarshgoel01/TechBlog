...
Posts post = p.getSinglePost(Integer.parseInt(pid));
%>
			...
			<div class="row text-center">
				<div class="col-md-8 offset-md-2 ">
					<div class="card">
						...
						<div class="card-body">
							<img class="card-img-top" src="blogPics/<%=post.getPic()%>">

							<div class="row my-3 post-info">

								<div class="col-md-6 mt-3 post-name">
									<p>
									<% 
									UserDao ud = new UserDao(ConnectionProvider.getConnection());
									User us = ud.getUserByUserId(post.getUid()); 
									
									session.setAttribute("userProfile", us);
									
									%>
										By <a href="showUserProfile.jsp"><%=us.getName()  %> </a> at :
									</p>
								</div>
								<div class="col-md-6 mt-3 post-date">
									<%=post.getDate().toLocaleString()%>
								</div>
							...
							<lable class="post-code-lable">Code : </lable><br><br>
						...
						<div class="card footer primary-background">
							...
							<a href="#!"
								class="btn btn-outline-light primary-background btn-sm"> <i
								class="fa fa-thumbs-o-up"></i><span>10</span>
							</a> <a href="#!"
								class="btn btn-outline-light primary-background btn-sm"> <i
								class="fa fa-commenting-o"></i>10
							</a>
